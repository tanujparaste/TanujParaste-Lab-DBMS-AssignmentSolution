...
CREATE TABLE product(
	...
	pro_desc VARCHAR(60),
	cat_id INT,
	CONSTRAINT product_fk_category FOREIGN KEY (cat_id) REFERENCES category(cat_id)
);
...
CREATE TABLE supplier_pricing(
	...
	CONSTRAINT supplier_pricing_fk_product FOREIGN KEY (pro_id) REFERENCES product(pro_id),
	CONSTRAINT supplier_pricing_fk_supplier FOREIGN KEY  (supp_id) REFERENCES supplier(supp_id)
);
...
CREATE TABLE `order`(
	...
	cus_id INT,
	pricing_id INT,
	CONSTRAINT order_fk_customer FOREIGN KEY (cus_id) REFERENCES customer(cus_id),
	CONSTRAINT order_fk_supplier_pricing FOREIGN KEY (pricing_id) REFERENCES supplier_pricing(pricing_id)
);
...
CREATE TABLE rating(
	...
	CONSTRAINT rating_fk_order FOREIGN KEY (ord_id) REFERENCES `order`(ord_id)
);
